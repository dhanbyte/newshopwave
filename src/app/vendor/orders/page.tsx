                  ...
                  <div className="text-right">
                    ...
                    {order.isDropshipperOrder && order.dropshipperSellingPrice && (
                      <div className="text-sm text-blue-600 font-medium">
                        🏷️ Selling: ₹{order.dropshipperSellingPrice.toLocaleString()}
                      </div>
                    )}
                ...
                <div className="text-right">
                  ...
                  {selectedOrder.isDropshipperOrder && selectedOrder.dropshipperSellingPrice && (
                    <div className="text-lg text-blue-600 font-semibold">
                      🏷️ Customer Pays: ₹{selectedOrder.dropshipperSellingPrice.toLocaleString()}
                    </div>
                  )}
                  <div
                  ...
                  {selectedOrder.isDropshipperOrder && selectedOrder.dropshipperSellingPrice && (
                    <>
                      <div className="flex justify-between text-lg font-bold text-blue-600">
                        ...
                        <span>₹{selectedOrder.dropshipperSellingPrice.toLocaleString()}</span>
                      </div>
                      <div className="flex justify-between text-sm text-green-600 font-medium border-t pt-2">
                        <span>Dropshipper Profit:</span>
                        <span>₹{(selectedOrder.dropshipperSellingPrice - selectedOrder.total).toLocaleString()}</span>
                      </div>
                    </>
                  )}
                </div>
