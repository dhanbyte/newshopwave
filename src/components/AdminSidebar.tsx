...
import { BarChart3, Package, Users, ShoppingCart, ArrowLeft, Home, Grid3X3, CreditCard, FileText } from 'lucide-react'
...
const menuItems = [
  ...
  { icon: FileText, label: 'Dropshipper Leads', href: '/admin/leads', emoji: '📋' },
