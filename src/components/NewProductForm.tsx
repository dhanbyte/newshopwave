...
export default function ProductForm({ product, onSave, onCancel }: ProductFormProps) {
    const [formData, setFormData] = useState({
        ...
        category: (product as any)?.category || 'Pooja',
        subcategory: (product as any)?.subcategory || 'Aasan and Mala',
        price_original: (product as any)?.price_original || 0,
        price_currency: (product as any)?.price_currency || '₹',
        quantity: (product as any)?.quantity || 0,
        description: (product as any)?.description || '',
        features: (product as any)?.features || [],
        ratings_average: (product as any)?.ratings_average || 0,
        ratings_count: (product as any)?.ratings_count || 0,
        extraImages: (product as any)?.extraImages || []
    })
